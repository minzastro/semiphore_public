...
BANDS = {
    ...
    'DES': ['%smag' % s for s in list('grizy')],
    'DES2': ['mag_auto_%s' % s for s in list('grizy')],
    'KIDS': ['%smag' % s for s in list('ugri')],
    'LAS': ['%sAperMag3' % s for s in ['y', 'j_1', 'h', 'k']],
    'LAS2': ['p%smag' % s for s in ['y', 'j', 'h', 'k']],
...
EXTINCTIONS = {
    ...
    'DES2': [3.237, 2.176, 1.595, 1.217, 1.058],
    'KIDS': [4.239, 3.303, 2.285, 1.698],
    'LAS': [1.194957, 0.895497, 0.568943, 0.356779],
    'LAS2': [1.194957, 0.895497, 0.568943, 0.356779],
    'LS8': [0, 0, 0],
...
LIMITS = {
    ...
    'DES2': [24.33, 24.08, 23.44, 22.69, 21.44],
    'KIDS': [24.3, 25.4, 25.2, 24.2],
    'LAS': [20.5, 20.0, 18.8, 18.4],
    'LAS2': [20.5, 20.0, 18.8, 18.4],
    'LS8': [24.5, 23.9, 22.9],
